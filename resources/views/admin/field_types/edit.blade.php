...
@section('header', 'Edit Jenis Lapangan')
    ...
    <div class="bg-white rounded-lg shadow p-6 max-w-lg">
        <form action="{{ route('admin.field-types.update', $fieldType) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" value="{{ $fieldType->name }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 sm:text-sm p-2 border" required>
